...
public class CategoryResource {
	...
	@ApiOperation("Metodo que devuelve una categoria, pasandoré una id")
	@GetMapping(path = "/{id}")
	...
	@ApiOperation("Metodo que devuelve una lista corta, pasandoré una id")
	...
	@ApiOperation("Metodo que añade una nueva categoría")
	@PostMapping
	...
	@ApiOperation("Metodo que modifica una categoria, pasandoré una id")
	@PutMapping("/{id}")
	...
	@ApiOperation("Metodo que elimana una categoria, pasandoré una id")
	@DeleteMapping("/{id}")
